...
insert into transaction_info(parent_id, business_id, business_type, tx_type, tx_status, context, payload, retried_count) values (1, 'business_id', 'business_type', 1, 1, 'context', 'payload', 3);